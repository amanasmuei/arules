...
└── arules    →  guardrails  (what it MUST/MUST NOT do)
```
...
| Workflows | [aflow](https://github.com/amanasmuei/aflow) | Multi-step AI workflows |
| Guardrails | **arules** | Safety rules and permissions |
